 ...
 */
final class Version20250430230831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur ADD reset_token VARCHAR(100) DEFAULT NULL, ADD reset_token_expires_at DATETIME DEFAULT NULL, CHANGE is_blocked is_blocked TINYINT(1) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur DROP reset_token, DROP reset_token_expires_at, CHANGE is_blocked is_blocked TINYINT(1) DEFAULT 0 NOT NULL
        SQL);
    }
}
