 ...
 */
final class Version20250428214416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur ADD is_verified TINYINT(1) NOT NULL, ADD verification_token VARCHAR(100) DEFAULT NULL, CHANGE is_blocked is_blocked TINYINT(1) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE utilisateur DROP is_verified, DROP verification_token, CHANGE is_blocked is_blocked TINYINT(1) DEFAULT 0 NOT NULL
        SQL);
    }
}
